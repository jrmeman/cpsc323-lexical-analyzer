/*  Justin Meman
    ...
    Write a lexical analyzer using an FSM as a foundation. The program output displays a list of tokens and lexemes in 
    the form of keywords, identifiers, separators, operators, integers and real numbers.
*/
